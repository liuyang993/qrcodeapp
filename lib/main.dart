      ...
      child: Scaffold(
        ...
        bottomNavigationBar: CupertinoTabBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(icon:Icon(Icons.account_box),title: Container(child:
              Text(
                    'Site',
            ...
            BottomNavigationBarItem(icon:Icon(Icons.scanner),title: Container(child:
              Text(
                    'Scan',
                    textAlign: TextAlign.left,
                    style: TextStyle(
